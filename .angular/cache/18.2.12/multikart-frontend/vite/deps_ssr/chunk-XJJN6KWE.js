...
var NgxsBootstrapper = class {
  constructor() {
    this.bootstrap$ = new import_rxjs.ReplaySubject(1);
  }
  get appBootstrapped$() {
...
NgxsBootstrapper.ɵfac = function NgxsBootstrapper_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxsBootstrapper)();
};
...
DispatchOutsideZoneNgxsExecutionStrategy.ɵfac = function DispatchOutsideZoneNgxsExecutionStrategy_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DispatchOutsideZoneNgxsExecutionStrategy)(ɵɵinject(NgZone), ɵɵinject(PLATFORM_ID));
};
...
NgxsConfig.ɵfac = function NgxsConfig_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxsConfig)();
};
NgxsConfig.ɵprov = ɵɵdefineInjectable({
  token: NgxsConfig,
  factory: function NgxsConfig_Factory2(__ngFactoryType__) {
    let __ngConditionalFactory__ = null;
    if (__ngFactoryType__) {
      __ngConditionalFactory__ = new __ngFactoryType__();
    } else {
      __ngConditionalFactory__ = ((options) => mergeDeep(new NgxsConfig(), options))(ɵɵinject(ROOT_OPTIONS));
    }
...
NoopNgxsExecutionStrategy.ɵfac = function NoopNgxsExecutionStrategy_Factory(__ngFactoryType__) {
...
function leaveNgxs(ngxsExecutionStrategy) {
  return (source) => {
    return new import_rxjs2.Observable((sink) => {
...
InternalNgxsExecutionStrategy.ɵfac = function InternalNgxsExecutionStrategy_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || InternalNgxsExecutionStrategy)(ɵɵinject(NGXS_EXECUTION_STRATEGY));
};
...
var OrderedSubject = class extends import_rxjs2.Subject {
  constructor() {
    super(...arguments);
...
var OrderedBehaviorSubject = class extends import_rxjs2.BehaviorSubject {
  constructor(value) {
    super(value);
...
InternalActions.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function InternalActions_Factory(__ngFactoryType__) {
    return (ɵInternalActions_BaseFactory || (ɵInternalActions_BaseFactory = ɵɵgetInheritedFactory(InternalActions)))(__ngFactoryType__ || InternalActions);
  };
})();
...
var Actions = class extends import_rxjs2.Observable {
...
Actions.ɵfac = function Actions_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || Actions)(ɵɵinject(InternalActions), ɵɵinject(InternalNgxsExecutionStrategy));
};
...
InternalErrorReporter.ɵfac = function InternalErrorReporter_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || InternalErrorReporter)(ɵɵinject(Injector));
};
...
StateStream.ɵfac = function StateStream_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || StateStream)();
};
...
PluginManager.ɵfac = function PluginManager_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || PluginManager)(ɵɵinject(PluginManager, 12), ɵɵinject(NGXS_PLUGINS, 8));
};
...
var InternalDispatchedActionResults = class extends import_rxjs2.Subject {
};
InternalDispatchedActionResults.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function InternalDispatchedActionResults_Factory(__ngFactoryType__) {
    return (ɵInternalDispatchedActionResults_BaseFactory || (ɵInternalDispatchedActionResults_BaseFactory = ɵɵgetInheritedFactory(InternalDispatchedActionResults)))(__ngFactoryType__ || InternalDispatchedActionResults);
  };
})();
...
var InternalDispatcher = class {
  ...
  dispatchByEvents(actionOrActions) {
    if (Array.isArray(actionOrActions)) {
      if (actionOrActions.length === 0) return (0, import_rxjs2.of)(this._stateStream.getValue());
      return (0, import_rxjs2.forkJoin)(actionOrActions.map((action) => this.dispatchSingle(action)));
    } else {
  ...
  createDispatchObservable(actionResult$) {
    return actionResult$.pipe((0, import_operators.exhaustMap)((ctx) => {
      switch (ctx.status) {
        case "SUCCESSFUL":
...
InternalDispatcher.ɵfac = function InternalDispatcher_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || InternalDispatcher)(ɵɵinject(InternalActions), ɵɵinject(InternalDispatchedActionResults), ɵɵinject(PluginManager), ɵɵinject(StateStream), ɵɵinject(InternalNgxsExecutionStrategy), ɵɵinject(InternalErrorReporter));
};
...
InternalStateOperations.ɵfac = function InternalStateOperations_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || InternalStateOperations)(ɵɵinject(StateStream), ɵɵinject(InternalDispatcher), ɵɵinject(NgxsConfig));
};
...
StateContextFactory.ɵfac = function StateContextFactory_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || StateContextFactory)(ɵɵinject(InternalStateOperations));
};
...
NgxsUnhandledActionsLogger.ɵfac = function NgxsUnhandledActionsLogger_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxsUnhandledActionsLogger)(ɵɵinject(NGXS_DEVELOPMENT_OPTIONS));
};
...
var StateFactory = class _StateFactory {
  ...
  connectActionHandlers() {
    ...
    const dispatched$ = new import_rxjs2.Subject();
    this._actionsSubscription = this._actions.pipe((0, import_operators.filter)(
      (ctx) => ctx.status === "DISPATCHED"
      /* Dispatched */
    ), (0, import_operators.mergeMap)((ctx) => {
      dispatched$.next(ctx);
      const action = ctx.action;
      return this.invokeActions(dispatched$, action).pipe((0, import_operators.map)(() => ({
        action,
        status: "SUCCESSFUL"
        /* Successful */
      })), (0, import_operators.defaultIfEmpty)({
        action,
        status: "CANCELED"
        /* Canceled */
      }), (0, import_operators.catchError)((error) => (0, import_rxjs2.of)({
        action,
        status: "ERRORED",
        error
      })));
  ...
  invokeActions(dispatched$, action) {
        ...
        for (const actionMeta of actionMetas) {
          ...
          try {
            ...
            if ((0, import_rxjs2.isObservable)(result)) {
              result = result.pipe((0, import_operators.mergeMap)((value) => {
              ...
              if (actionMeta.options.cancelUncompleted) {
                result = result.pipe((0, import_operators.takeUntil)(dispatched$.pipe(ofActionDispatched(action))));
              }
            } else {
              result = (0, import_rxjs2.of)({}).pipe((0, import_operators.shareReplay)());
            }
            results.push(result);
          } catch (e) {
            results.push((0, import_rxjs2.throwError)(e));
          }
    ...
    if (!results.length) {
      results.push((0, import_rxjs2.of)({}));
    }
...
StateFactory.ɵfac = function StateFactory_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || StateFactory)(ɵɵinject(Injector), ɵɵinject(NgxsConfig), ɵɵinject(StateFactory, 12), ɵɵinject(InternalActions), ɵɵinject(InternalDispatchedActionResults), ɵɵinject(StateContextFactory), ɵɵinject(INITIAL_STATE_TOKEN, 8));
};
...
var Store = class {
  constructor(_stateStream, _internalStateOperations, _config, _internalExecutionStrategy, _stateFactory, initialStateValue) {
    ...
    this._selectableStateStream = this._stateStream.pipe(leaveNgxs(this._internalExecutionStrategy), (0, import_operators.shareReplay)({
      bufferSize: 1,
      refCount: true
    }));
  ...
  select(selector) {
    ...
    return this._selectableStateStream.pipe((0, import_operators.map)(selectorFn), (0, import_operators.catchError)((err) => {
      const {
        suppressErrors
    ...
    }), (0, import_operators.distinctUntilChanged)(), leaveNgxs(this._internalExecutionStrategy));
  }
  selectOnce(selector) {
    return this.select(selector).pipe((0, import_operators.take)(1));
  }
...
Store.ɵfac = function Store_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || Store)(ɵɵinject(StateStream), ɵɵinject(InternalStateOperations), ɵɵinject(NgxsConfig), ɵɵinject(InternalNgxsExecutionStrategy), ɵɵinject(StateFactory), ɵɵinject(INITIAL_STATE_TOKEN, 8));
};
...
SelectFactory.ɵfac = function SelectFactory_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SelectFactory)(ɵɵinject(Store), ɵɵinject(NgxsConfig));
};
...
var LifecycleStateManager = class {
  ...
  ngxsBootstrap(action, results) {
    this._internalStateOperations.getRootStateOperations().dispatch(action).pipe((0, import_operators.filter)(() => !!results), (0, import_operators.tap)(() => this._invokeInitOnStates(results.states)), (0, import_operators.mergeMap)(() => this._bootstrapper.appBootstrapped$), (0, import_operators.filter)((appBootstrapped) => !!appBootstrapped), (0, import_operators.catchError)((error) => {
      this._internalErrorReporter.reportErrorSafely(error);
      return import_rxjs2.EMPTY;
    }), (0, import_operators.takeUntil)(this._destroy$)).subscribe(() => this._invokeBootstrapOnStates(results.states));
  }
...
LifecycleStateManager.ɵfac = function LifecycleStateManager_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || LifecycleStateManager)(ɵɵinject(Store), ɵɵinject(InternalErrorReporter), ɵɵinject(InternalStateOperations), ɵɵinject(StateContextFactory), ɵɵinject(NgxsBootstrapper));
};
...
NgxsRootModule.ɵfac = function NgxsRootModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxsRootModule)(ɵɵinject(StateFactory), ɵɵinject(InternalStateOperations), ɵɵinject(Store), ɵɵinject(SelectFactory), ɵɵinject(ROOT_STATE_TOKEN, 8), ɵɵinject(LifecycleStateManager));
};
...
NgxsFeatureModule.ɵfac = function NgxsFeatureModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgxsFeatureModule)(ɵɵinject(Store), ɵɵinject(InternalStateOperations), ɵɵinject(StateFactory), ɵɵinject(FEATURE_STATE_TOKEN, 8), ɵɵinject(LifecycleStateManager));
};
...
NgxsModule.ɵfac = function NgxsModule_Factory(__ngFactoryType__) {
...
NgxsDevelopmentModule.ɵfac = function NgxsDevelopmentModule_Factory(__ngFactoryType__) {
...
//# sourceMappingURL=chunk-XJJN6KWE.js.map
